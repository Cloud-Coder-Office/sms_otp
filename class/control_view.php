<?php
	...
	function assign_route_capacity(){
...
/* 	function view_route_capacity_by_Id(){
	...
	function view_route_capacity($up_id){
	...
	function view_contract_by_id($id){
